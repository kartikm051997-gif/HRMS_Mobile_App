...
class _AllEmployeeScreenState extends State<AllEmployeeScreen> {
  ...
  Widget build(BuildContext context) {
    final allEmployeesProvider = Provider.of<AllEmployeesProvider>(context);
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: InkWell(
                              onTap: allEmployeesProvider.toggleFilters,
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const Spacer(),
                                    Icon(
                                      allEmployeesProvider.showFilters
                                          ? Icons.expand_less
                                          : Icons.expand_more,
                                      color: const Color(0xFF475569),
                                    ),
                      ...
                      Container(
                        ...
                        child: TextField(
                          controller: allEmployeesProvider.searchController,
                          onChanged: (value) {
                            allEmployeesProvider.onSearchChanged(value);
                          },
                          style: TextStyle(
                            fontSize: 16,
                            fontFamily: AppFonts.poppins,
          ...
          if (allEmployeesProvider.showFilters)
            SliverToBoxAdapter(
              child: Container(
                width: double.infinity,
                color: Colors.white,
                      ...
                      children: [
                        Expanded(
                          child: CustomSearchDropdownWithSearch(
                            labelText: "Zone",
                            items: allEmployeesProvider.zone,
                            selectedValue: allEmployeesProvider.selectedZone,
                            onChanged: allEmployeesProvider.setSelectedZone,
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: CustomSearchDropdownWithSearch(
                            labelText: "Branch",
                            items: allEmployeesProvider.branch,
                            selectedValue: allEmployeesProvider.selectedBranch,
                            onChanged: allEmployeesProvider.setSelectedBranch,
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              allEmployeesProvider.searchEmployees();
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "${allEmployeesProvider.filteredEmployees.length} Employees Found",
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.w600,
                      fontFamily: AppFonts.poppins,
                  ...
                  if (allEmployeesProvider.showFilters)
                    TextButton.icon(
                      onPressed: () {
                        allEmployeesProvider.toggleFilters();
                      },
