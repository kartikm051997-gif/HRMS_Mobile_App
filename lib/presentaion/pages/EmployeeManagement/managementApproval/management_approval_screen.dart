        ...
        child: CustomScrollView(
          slivers: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: _buildFilterToggle(managementApprovalProvider),
                        ),
                    ...
                    _buildSearchField(managementApprovalProvider),
                  ],
                ),
              ),
            ),
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 16),
                      _buildFiltersGrid(managementApprovalProvider),
                      const SizedBox(height: 20),
                      _buildSearchButton(managementApprovalProvider),
                    ],
                  ),
                ),
              ),
            ...
            SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.all(16),
                child: _buildListHeader(managementApprovalProvider),
              ),
            ),

            // Employee List
            _buildEmployeeSliverList(managementApprovalProvider),
          ],
        ),
      ),
    );
...
Widget _buildSearchField(
  ManagementApprovalProvider managementApprovalProvider,
) {
  return Container(
    ...
    child: TextField(
      controller: managementApprovalProvider.searchController,
      onChanged: (value) {
      ...
      decoration: InputDecoration(
        ...
        suffixIcon:
            managementApprovalProvider.searchController.text.isNotEmpty
                ? IconButton(
                  onPressed: () {
                    managementApprovalProvider.clearSearch();
                  },
                  icon: const Icon(
                    Icons.clear_rounded,
        ...
        children: [
          Expanded(
            child: CustomSearchDropdownWithSearch(
              ...
              selectedValue: managementApprovalProvider.selectedZone,
              onChanged: managementApprovalProvider.setSelectedZone,
        ...
        children: [
          Expanded(
            child: CustomSearchDropdownWithSearch(
              ...
              selectedValue: managementApprovalProvider.selectedBranch,
              onChanged: managementApprovalProvider.setSelectedBranch,
          ...
          Expanded(
            child: CustomSearchDropdownWithSearch(
              ...
              selectedValue: managementApprovalProvider.selectedDesignation,
              onChanged: managementApprovalProvider.setSelectedDesignation,
...
Widget _buildListHeader(ManagementApprovalProvider managementApprovalProvider) {
  return Row(
...
Widget _buildEmployeeSliverList(
  ManagementApprovalProvider managementApprovalProvider,
) {
  if (managementApprovalProvider.isLoading) {
  ...
  if (managementApprovalProvider.filteredEmployees.isEmpty) {
  ...
  return SliverList(
    delegate: SliverChildBuilderDelegate((context, index) {
      final employee = managementApprovalProvider.filteredEmployees[index];
      return Padding(
        padding: const EdgeInsets.symmetric(horizontal: 16),
        child: _buildEmployeeCard(context, employee),
      );
    }, childCount: managementApprovalProvider.filteredEmployees.length),
  );
}
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder:
                  (_) => EmploManagementApprovalDetailsScreen(
...
Widget _buildEmployeeAvatar(Employee employee) {
  return Container(
    ...
    child: ClipOval(child: _buildAvatarContent(employee)),
  );
}
...
Widget _buildAvatarContent(Employee employee) {
  ...
  if (employee.photoUrl != null &&
      ...
      employee.photoUrl != "https://example.com/photo1.jpg") {
    // Avoid known invalid URLs
