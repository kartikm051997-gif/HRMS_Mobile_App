            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  if (widget.employee.mobile != null && widget.employee.mobile!.isNotEmpty)
                    _buildDetailRow(
                      "Mobile",
                  ...
                  if (widget.employee.annualCtc != null && widget.employee.annualCtc!.isNotEmpty)
                    _buildDetailRow(
                      "Annual CTC",
                  ...
                  if (widget.employee.recentPunchDate != null && widget.employee.recentPunchDate!.isNotEmpty)
                    _buildDetailRow(
                      "Recent Punch",
                      widget.employee.recentPunchDate!,
                      Icons.access_time_rounded,
                      isLast: true,
                    ),
                  if (widget.employee.recentPunchDate == null || widget.employee.recentPunchDate!.isEmpty)
                    _buildDetailRow(
                      "Status",
                      widget.employee.status,
                      Icons.info_rounded,
