      ...
      body: CustomScrollView(
        slivers: [
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    const Spacer(),
                                    Icon(
                                      f11EmployeeProvider.showFilters
                                          ? Icons.expand_less
                                          : Icons.expand_more,
                                      color: const Color(0xFF475569),
                                    ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: CustomSearchDropdownWithSearch(
                            ...
                            selectedValue:
                                f11EmployeeProvider.selectedDesignation,
                            onChanged:
                                f11EmployeeProvider.setSelectedDesignation,
                      ...
                      children: [
                        Expanded(
                          child: OutlinedButton(
                            onPressed: () {
                              f11EmployeeProvider.clearAllFilters();
                            },
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              f11EmployeeProvider.searchEmployees();
                            },
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "${f11EmployeeProvider.filteredEmployees.length} Employees Found",
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.w600,
                      fontFamily: AppFonts.poppins,
                  ...
                  if (f11EmployeeProvider.showFilters)
                    TextButton.icon(
                      onPressed: () {
                        f11EmployeeProvider.toggleFilters();
                      },
          ...
          f11EmployeeProvider.isLoading
              ...
              : f11EmployeeProvider.filteredEmployees.isEmpty
              ? SliverFillRemaining(
                child: Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
              ...
              : SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate((context, index) {
                    final employee =
                        f11EmployeeProvider.filteredEmployees[index];
                    return Container(
                  ...
                  }, childCount: f11EmployeeProvider.filteredEmployees.length),
                ),
              ),
        ],
      ),
